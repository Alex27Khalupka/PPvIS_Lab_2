...
public class ArrivalStationSearchPanel {
    ...
    public ArrivalStationSearchPanel() {
        ...
        searchButton.addActionListener(actionEvent -> {
            try {
                ...
                if (!stationName.equals("")) {
                    List<Object[]> foundStudentList = Controller.arrivalStationSearch(stationName);
                    Frame mainFrame[] = JFrame.getFrames();
                    for (Frame frame : mainFrame) {
                        frame.setVisible(false);
                    }
    ...
    public static void createAndShowGUI(List<Object[]> trainList) throws ParseException {
        ...
        f.getContentPane().add(new ArrivalStationSearchPanel().makeUI(trainList));
        f.setSize(1000, 400);
