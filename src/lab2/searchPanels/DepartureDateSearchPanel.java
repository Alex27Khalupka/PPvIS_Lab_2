...
public class DepartureDateSearchPanel {
    ...
    public DepartureDateSearchPanel() {
    ...
    public JComponent makeUI(java.util.List<Object[]> trainList) throws ParseException{
        ...
        searchButton.addActionListener(actionEvent -> {
            try {
                ...
                List<Object[]> foundTrainList = Controller.departureDateSearch(departureDate);
                Frame mainFrame[] = JFrame.getFrames();
                for (Frame frame : mainFrame) {
                    frame.setVisible(false);
                }
    ...
    public static void createAndShowGUI(List<Object[]> trainList) throws ParseException {
        ...
        f.getContentPane().add(new DepartureDateSearchPanel().makeUI(trainList));
        f.setSize(1000, 400);
