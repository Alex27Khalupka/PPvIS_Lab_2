...
public class DepartureStationSearchPanel {
    ...
    public DepartureStationSearchPanel() {
        ...
        searchButton.addActionListener(actionEvent -> {
            try {
                ...
                if (!stationName.equals("")) {
                    List<Object[]> foundStudentList = Controller.departureStationSearch(stationName);
                    Frame mainFrame[] = JFrame.getFrames();
                    for (Frame frame : mainFrame) {
                        frame.setVisible(false);
                    }
    ...
    public static void createAndShowGUI(List<Object[]> trainList) throws ParseException {
        ...
        f.getContentPane().add(new DepartureStationSearchPanel().makeUI(trainList));
        f.setSize(1000, 400);
