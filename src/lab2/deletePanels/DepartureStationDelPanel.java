...
public class DepartureStationDelPanel {
        ...
        deleteButtonButton.addActionListener(actionEvent -> {
            try {
                ...
                if (!stationName.equals("")){
                    int countDeletedRows = Controller.departureStationDelete(stationName);
    ...
    public static void createAndShowGUI() {
        ...
        f.getContentPane().add(new DepartureStationDelPanel().makeUI());
        f.setSize(400, 150);
