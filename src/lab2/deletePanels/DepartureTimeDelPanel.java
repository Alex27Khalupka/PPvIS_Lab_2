...
public class DepartureTimeDelPanel {
    ...
    public JComponent makeUI() {
        ...
        deleteButtonButton.addActionListener(actionEvent -> {
            try {
                ...
                int countDeletedRows = Controller.departureTimeDelete(lowerTime, upperTime);
    ...
    public static void createAndShowGUI() {
        ...
        f.getContentPane().add(new DepartureTimeDelPanel().makeUI());
        f.setSize(400, 150);
